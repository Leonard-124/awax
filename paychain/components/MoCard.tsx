      ...
      {loading ? (
        ...
        <>
          <View className="flex-row justify-between mb-3">
            ...
            <View className="items-end">
              <Text className="text-emerald-400 text-xs mb-1">Till No.</Text>
              <Text className="text-white font-medium text-sm">{data.tillNumber}</Text>
            </View>
          </View>
          <View className="border-t border-emerald-800 pt-3 flex-row justify-between">
            <View>
              <Text className="text-emerald-400 text-xs mb-1">Last Deposit</Text>
              <Text className="text-white font-bold text-base">
                KES {data.lastDeposit.toLocaleString()}
              </Text>
              {data.lastDepositDate ? (
            ...
            <View className="items-end">
              <Text className="text-emerald-400 text-xs mb-1">Pending Settlement</Text>
              <Text className={`font-bold text-base ${
                data.pendingSettlement > 0 ? 'text-amber-400' : 'text-emerald-300'
              }`}>
                KES {data.pendingSettlement.toLocaleString()}
              </Text>
            </View>
